...
export class YouTubePlayer {
    ...
    public async triggerAtmosphere(): Promise<void> {
        console.log("[Atmosphere] Triggering atmosphere overlay");
        try {
            await this.page.evaluate(() => {
                ...
                if (!document.body) {
                    console.warn("[Atmosphere] Body element unavailable");
                }
            ...
            console.error("[Atmosphere] triggerAtmosphere failed", error);
        }
    }
}